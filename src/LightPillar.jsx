...
const LightPillar = ({
  ...
  useEffect(() => {
    ...
    try {
      ...
      console.error('LightPillar: WebGLRenderer init failed', error)
    ...
    // ensure background canvas doesn't capture pointer events
    renderer.domElement.style.pointerEvents = 'none'
    container.appendChild(renderer.domElement)
    rendererRef.current = renderer

    console.log('LightPillar init', { width, height, effectiveQuality, settings })
    ...
    try {
      ...
      console.error('LightPillar shader compilation failed', err)
      webGLSupported(false)
      return
    }
